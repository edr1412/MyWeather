    ...
    private void findView() {
        ...
        update_frequency.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                editor.commit();
                Intent intent = new Intent(SettingActivity.this, WeatherDataUpdateService.class);
                //intent.putExtra("anHour", ((TextView) arg1).getText().charAt(0) - 48);
                //Log.d("saved", " "+ (((TextView) arg1).getText().charAt(0) - 48));
        ...
        switch (compoundButton.getId()) {
            case R.id.back_update:
                if (compoundButton.isChecked()) {
                    ...
                    editor.commit();
                    update_frequency.setEnabled(true);
                    Intent intent = new Intent(this, WeatherDataUpdateService.class);
                    intent.putExtra("anHour", -1);
                    startService(intent);
                } else {
                    SharedPreferences.Editor editor = getSharedPreferences("settings", MODE_PRIVATE).edit();
